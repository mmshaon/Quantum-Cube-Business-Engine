...
exports.handler = async (event) => {
  ...
  try {
    // ১. কোর ইউজার ও অথ টেবিল (Module 1)
    ...
    // ২. কিউব ও মডিউল ম্যানেজমেন্ট (Module 2)
    ...
    // ৫. ইউসরা ইন্টেলিজেন্স ও লগ (Yusra Master Logic)
    ...
    return { 
      ...
      body: JSON.stringify({ status: "SUCCESS", message: "All QCBE & Yusra Modules Initialized!" }) 
    };
  } catch (err) {
    return { 
      statusCode: 500, 
